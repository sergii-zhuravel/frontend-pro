...
## Introduction
ECMAScript 6, также известный как ECMAScript 2015, is the latest version of the ECMAScript standard.  ES6 является значительным обновлением языка, и первым обновлением после того как ES5 был стандартизирован в 2009 году. Реализацию этих фич основными JavaScript движками можно посмотреть тут (http://kangax.github.io/es5-compat-table/es6/).

 Тут [ES6 standard](http://www.ecma-international.org/ecma-262/6.0/) можно посмотреть полную спецификацию ECMAScript 6 языка.

ES6 включает следующие новые возможности:
- [arrows](#arrows)
- [classes](#classes)
...
Arrows (или стрелочные функции) являются особым видом фукнции которые используют `=>` в своем синтаксе. Они синтаксически похожи на такуюже возможность в C#, Java 8 и CoffeeScript.  Они поддерживают два вида блоков тела - statement block и expression которое возвращает значение выражение. В отличии от обычных фукнций, стрелочные функции share the same lexical `this` as their surrounding code.
